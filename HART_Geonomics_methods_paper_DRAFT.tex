...
\begin{figure}[ht!]
\includegraphics[width=125mm]{./img/final/flow_diagram.png}
...
\begin{figure}[ht!]
\includegraphics[width=150mm]{./img/final/move_surf_histograms.png}
...
\begin{figure}[ht!]
\includegraphics[width=150mm]{./img/final/move_surf_tracks.png}
...
\begin{figure}[ht!]
        \includegraphics[width=175mm]{./img/final/IBD_IBE_PCA.png}
...
\begin{figure}[ht!]
        \includegraphics[width=175mm]{./img/final/IBD_IBE_scatter.png}
        \caption{Isolation by distance (IBD) and isolation by environment (IBE):
...
\begin{figure}[ht!]
        \includegraphics[width=175mm]{./img/final/YOSEMITE_time_series.png}
